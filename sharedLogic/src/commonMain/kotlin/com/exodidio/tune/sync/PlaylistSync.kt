...
object PlaylistSyncProtocol {
    fun requestTopic(desktopId: String, mobileId: String) = "tune/playlist-sync/v1/$desktopId/$mobileId/request"
    fun resultTopic(desktopId: String, mobileId: String) = "tune/playlist-sync/v1/$desktopId/$mobileId/result"
