...
import com.exodidio.tune.pairing.Base64Url
...
class PlaylistSyncProtocolTest {
    @Test fun `uses isolated reconciliation topics and compact signing input`() {
        ...
        assertEquals("tune/playlist-sync/v1/desktop/mobile/request", PlaylistSyncProtocol.requestTopic("desktop", "mobile"))
        assertEquals("tune/playlist-sync/v1/desktop/mobile/result", PlaylistSyncProtocol.resultTopic("desktop", "mobile"))
