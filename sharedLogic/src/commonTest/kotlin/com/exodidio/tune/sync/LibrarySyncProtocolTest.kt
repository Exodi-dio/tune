...
class LibrarySyncProtocolTest {
    ...
    fun usesDeviceScopedV1Topics() {
        assertEquals("tune/library-sync/v1/desktop/mobile/request", LibrarySyncProtocol.requestTopic("desktop", "mobile"))
        assertEquals("tune/library-sync/v1/desktop/mobile/receipt", LibrarySyncProtocol.receiptTopic("desktop", "mobile"))
    }
