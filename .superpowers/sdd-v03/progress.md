...
- Review: Needs fixes (4 Critical lost-functionality + 4 Important). Fix wave: ALL 8 ADDRESSED, no breakage (re-review PASS). GREEN 36274742051.
- Final batch: complete (review clean after 1 fix round).
