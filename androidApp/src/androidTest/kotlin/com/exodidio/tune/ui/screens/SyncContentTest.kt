...
class SyncContentTest {
    ...
    fun offlinePairedDesktopShowsReadyToConnectGuidanceAndRevokeActionInDeviceCard() {
        ...
        composeTestRule.onNodeWithText("Ready to connect. Start Broadcast in Tune on your desktop; this screen connects automatically.").assertIsDisplayed()
    ...
    fun mobileSyncHelpOpensTheFaq() {
        ...
        assertEquals("https://tune.pages.dev/faq/mobile-sync", openedUrl)
    }
}
