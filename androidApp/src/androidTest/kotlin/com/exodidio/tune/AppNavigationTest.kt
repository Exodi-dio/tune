...
class AppNavigationTest {
    ...
    fun equalizerHeaderMenuResetsBuiltInProfile() {
        ...
        composeTestRule.setContent {
            App(
                ...
                destinations = AppDestinationModels(
                    settings = SettingsDestinationModel(
                        equalizer = com.exodidio.tune.player.EqualizerSettings(
                            presetKey = "rock",
    ...
    fun equalizerHeaderMenuConfirmsDeletingUserProfile() {
        ...
        val profile = com.exodidio.tune.player.EqualizerProfile("user_test", "Custom", List(10) { 0f }, isDefault = false)
        composeTestRule.setContent {
            App(
                uiState = AppUiState(selectedDestination = AppDestination.Settings),
                destinations = AppDestinationModels(
                    settings = SettingsDestinationModel(
                        equalizer = com.exodidio.tune.player.EqualizerSettings(presetKey = profile.key, userProfiles = listOf(profile)),
