...
class HiveMqSyncSession : SyncSession {
    ...
    override fun connect(desktop: PairedDesktop, endpoint: PairingEndpoint, mobileId: String, reconnect: Boolean) {
        ...
        sessionJob = scope.launch {
            val mqttClient = MqttClient.builder()
                .useMqttVersion3()
                .identifier("tune-sync-${desktop.desktopId}-$mobileId")
            ...
            while (isActive) {
                ...
                if (mqttClient.state.isConnected) {
                    ...
                    runCatching {
                        val topic = "tune/library-sync/v1/${desktop.desktopId}/$mobileId/request"
                        ...
                        val playlistTopic = "tune/playlist-sync/v1/${desktop.desktopId}/$mobileId/request"
                        mqttClient.subscribeWith()
    ...
    companion object {
        private const val LogTag = "TuneSyncSession"
