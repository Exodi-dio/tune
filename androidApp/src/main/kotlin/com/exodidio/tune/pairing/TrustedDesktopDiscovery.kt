...
import com.exodidio.tune.pairing.PairingBroadcastRecord
import com.exodidio.tune.pairing.PairingBroadcastResolver
...
class AndroidTrustedDesktopDiscovery(context: Context) : TrustedDesktopDiscovery {
    ...
    private val multicastLock = appContext.getSystemService(WifiManager::class.java)
        .createMulticastLock("tune-pairing-discovery").apply { setReferenceCounted(false) }
    ...
    private companion object {
        const val ServiceType = "_tune-pair._tcp."
    }
}
