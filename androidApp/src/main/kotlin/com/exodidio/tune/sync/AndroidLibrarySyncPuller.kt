...
import com.exodidio.tune.sync.LibrarySyncAsset
import com.exodidio.tune.sync.LibrarySyncFailure
import com.exodidio.tune.sync.LibrarySyncPullException
import com.exodidio.tune.sync.LibrarySyncPuller
import com.exodidio.tune.sync.LibrarySyncRequest
import com.exodidio.tune.sync.PulledAsset
import com.exodidio.tune.sync.PulledManifest
...
internal class AndroidLibrarySyncPuller(
                    ...
                    when (val code = connection.responseCode) {
                        in 200..299 -> return connection.inputStream.use { input ->
                            destination.outputStream().use { output ->
                                ...
                                val headerHash = connection.getHeaderField("X-Tune-SHA256") ?: ""
    ...
    private companion object {
        private const val LogTag = "TuneSyncPuller"
    }
}
