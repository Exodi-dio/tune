...
import com.exodidio.tune.pairing.SyncSession
import com.exodidio.tune.sync.LibrarySyncClock
import com.exodidio.tune.sync.LibrarySyncCapacity
import com.exodidio.tune.sync.LibrarySyncCoordinator
import com.exodidio.tune.sync.LibrarySyncProtocol
import com.exodidio.tune.sync.LibrarySyncReceiptPublisher
import com.exodidio.tune.sync.LibrarySyncResult
import com.exodidio.tune.sync.LibrarySyncProgressReporter
...
class LibrarySyncService : Service() {
    ...
    companion object {
        ...
        private const val LogTag = "TuneLibrarySync"
